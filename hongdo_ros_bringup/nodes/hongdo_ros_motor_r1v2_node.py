...
from hongdo_packet_handler import PacketHandler2
from sensor_msgs.msg import Imu, JointState
from nav_msgs.msg import Odometry
from geometry_msgs.msg import Twist, Pose, Point, Vector3, Quaternion
from tf.broadcaster import TransformBroadcaster
from tf.transformations import quaternion_from_euler, euler_from_quaternion
from hongdo_ros_bringup.srv import ResetOdom, ResetOdomResponse
...
class hongdorosMotorNode:
   def __init__(self):
      ...
      # rospy.loginfo('Serial port: %s', self.ph.)
   ...
   def __del__(self):
      print("terminating hongdo_ros_motor_node")
      self.ph.close_port()
